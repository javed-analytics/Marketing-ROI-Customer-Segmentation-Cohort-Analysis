# Marketing ROI, Segmentation \& Cohort Analysis (Excel)

## Overview

This project evaluates marketing effectiveness, customer value concentration, and lifecycle behavior using Excel-based analytics and dashboarding.

The analysis focuses on **ROI efficiency**, **channel attribution**, **customer segmentation**, and **cohort-based engagement**, culminating in an executive-style dashboard.

## Business Questions

* Is current marketing spend delivering efficient ROI?
* Which channels generate the highest return?
* Where is customer value concentrated?
* How do customer cohorts evolve over time in value and engagement?
...
* Channel-level attribution \& ROI
* Spend-based customer segmentation
* Cohort value \& engagement trends
